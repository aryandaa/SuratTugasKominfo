...
<html>
  ...
  <script defer src="https://unpkg.com/alpinejs@3.2.3/dist/cdn.min.js"></script>
    <div class="felative flex flex-col justify-center min-h-screen overflow-hidden">
      <div class="w-full p-6 m-auto bg-white border-t-4 border-blue-600 rounded-[40px] shadow-lg shadow-blue-800/50 lg:max-w-md">
      <div class="p-8 ml-[105px]">
        <img src="foto/logo kominfo.png" class="w-[125px] h-[126px]">
      </div>
        ...
        <form action="" method="POST">
          ...
          <div class="mt-4">
            ...
            <input type="NIP" value="{{ old('NIP') }}" name="NIP" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md focus:border-blue-400 focus:ring-blue-300 focus:outline-none focus:ring-opacity-40 text-xl font-family" placeholder="Masukkan NIP...">
          </div>
            ...
            <div class="mt-4">
              <div class="relative" x-data="{ isVisible: false }">
                ...
                <div>
                  <button name="submit" type="submit" class="w-full px-4 py-2 mt-5 tracking-wide text-white transition-colors duration-200 transfrom bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:bg-blue-700">
                    Login</button>
                </div>
              </div>
            </div>
